  ...
  return (
    <section className="space-y-6">
      ...
      <button
        ...
        disabled={loading}
        className="w-full rounded-xl border-2 border-[#00ff00] bg-[#00ff00]/20 px-6 py-3 text-lg font-semibold uppercase tracking-[0.16em] text-[#00ff00] shadow-[0_0_20px_rgba(0,255,0,0.3)] transition hover:bg-[#00ff00]/30 hover:shadow-[0_0_30px_rgba(0,255,0,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
      >
